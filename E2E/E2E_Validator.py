...
class SQLServerClient:
    ...
    def get_data(self, resource_type):
        ...
        data_df = pd.read_sql(sql=sql, con=pyodbc.connect(self.connectionString))
        # Drop duplicated resources
        return data_df
...
if __name__ == "__main__":
    ...
    print('-> SqlUsername: ', Sql_Username[0:3])
    print('-> SqlPassword: ', Sql_Password[0:3])
        ...
        for future in concurrent.futures.as_completed(futures):
            ...
            if len(field_mapping_dict) != queried_df.shape[1]:
                ...
                raise Exception(f"Resource \"{resource_type}\" columns number is incorrect. "
                                ...
                                f"Expected - Queried = {expected_columns - queried_columns}, \r\n "
                                f"Queried - Expected = {queried_columns - expected_columns}.")
